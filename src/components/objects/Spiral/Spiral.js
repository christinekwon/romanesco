...
class Spiral extends Group {
    constructor(parent, listener, envMap, max_iter, direction, y_flip) {
        ...
        // this.bezier_curves[this.bezier_curves.length - 1].add(sound3);

        // const analyser3 = new THREE.AudioAnalyser(sound3, 32);
        // this.bezier_curves[this.bezier_curves.length - 1].material.emissive.b = analyser3.getAverageFrequency() / 256;
    ...
    rotate_bezier(degrees) {
        ...
        this.curveGroup.rotateOnWorldAxis(myAxis, THREE.MathUtils.degToRad(degrees));
    ...
    update(timeStamp) {
        this.curveGroup.rotateY(this.rotationSpeed);
